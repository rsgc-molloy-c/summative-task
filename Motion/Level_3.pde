//both ellipses accelerate towards one another
class Level_3 {
 ...
 // constructor
  ...
  void update() {
   ...
   RVector mouse2 = new RVector(location.x, location.x);
     RVector direction = RVector.sub(mouse, location);
    RVector direction2 = RVector.sub(mouse2, location2);
